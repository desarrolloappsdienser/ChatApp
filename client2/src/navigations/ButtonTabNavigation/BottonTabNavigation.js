...
import {
    ChatsNavigation,GroupsNavigation,SettingsNavigation,
} from "../stacks";
import {screens} from "../../Utils";
import {styles} from "./BottonTabNavigation.styles";
...
function screenIcon(route,color,size){
    ...
    return (
        <Icon as = {MaterialCommunityIcons} name = {iconName} color={color} size={size}></Icon>
    );
}